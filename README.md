...
4.  **Ejecuta el script de instalación:**
    ...
    *   Instalar Python3, pip, Firefox, XVFB y wget.
...
*   **Manualmente (para pruebas):**
    ...
    2.  Ejecuta el siguiente comando:
        ```bash
        sudo xvfb-run -a python3 app/app.py --host 0.0.0.0 --port 5000
        ```
...
*   **Usando Systemd (para producción y autoarranque):**
    1.  **Copia el archivo de servicio:**
        El archivo `whatsapp-sender.service` (incluido en el repositorio) define cómo systemd debe gestionar la aplicación.
        ```bash
